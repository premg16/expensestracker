...
export const moneyMood = [
  { label: "Float today", value: "$186", detail: "after bills, cards, and goals", icon: BadgeDollarSign },
  { label: "Bill pressure", value: "Calm", detail: "2 small renewals this week", icon: CalendarClock },
...
export const challenges = [
  ...
  { title: "Cancel one dusty subscription", prize: "$17 monthly save", progress: "Ready to review" },
